  ...
  <div class="min-h-[100dvh] overflow-hidden text-gray-900 flex flex-col">
    ...
    <div class="flex-1 max-w-5xl mx-auto w-full px-4 pt-6 pb-8 md:pt-10 md:pb-10 md:flex md:items-center">
      <div class="grid md:grid-cols-2 gap-6 md:gap-10 items-start w-full">
        ...
        <div class="min-w-0">
          <h1 class="text-2xl md:text-3xl font-bold tracking-tight mb-3 text-gray-900">Complete Registration</h1>
          <p class="text-sm text-gray-900/70 mb-6">Please enter your invite code to complete your Google account registration.</p>
          ...
          <div class="glass-card-no-hover rounded-xl border border-white/12 p-6">
            <form @submit.prevent="handleSubmit" class="space-y-4">
              <div>
                <label class="block text-xs text-gray-900/80 font-medium mb-2">Email</label>
                <input
                  :value="email"
                  type="email"
                  readonly
              ...
              <div>
                <label class="block text-xs text-gray-900/80 font-medium mb-2">Invite Code <span class="text-red-400">*</span></label>
                <input
                  v-model.trim="inviteCode"
                  type="text"
                  required
                  autofocus
                  class="w-full px-3 py-2.5 text-sm glass-input rounded-lg text-gray-900 placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-white/20 transition-all uppercase"
                  placeholder="Enter invite code"
                />
                <p class="text-xs text-gray-900/50 mt-1">Invite code is required to complete registration</p>
              </div>
