<template>
  <div class="min-h-[100dvh] overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950 text-white">
    ...
    <div class="max-w-md mx-auto px-4 py-6">
      <h1 class="text-3xl font-bold tracking-tight mb-5">Create Account</h1>
      ...
      <div class="glass-card-no-hover rounded-xl border border-white/12 p-4">
        ...
        <form v-if="showVerification" @submit.prevent="handleVerify" class="space-y-4">
          <div class="text-center mb-2">
            <p class="text-white/80 mb-1">{{ t('auth.sentCodeTo') }}</p>
          ...
          <div>
            ...
            <input
              ...
              required
              maxlength="6"
              class="w-full px-4 py-4 glass-input rounded-lg text-white text-center text-3xl tracking-[0.5em] font-bold focus:outline-none focus:ring-2 focus:ring-white/20 transition-all"
              placeholder="000000"
          ...
          <button
            ...
            class="w-full py-3 rounded-full font-semibold border border-white/15 text-white/90 hover:bg-white/10 transition-colors"
          >
            {{ t('auth.back') }}
          </button>
        </form>
        ...
        <div v-else>
          <!-- EMAIL MODE -->
          <form v-if="registerMode === 'email'" @submit.prevent="onPrimaryAction" class="space-y-3">
            <!-- Step 1: email + invite -->
            <div v-if="step === 'identifier'" class="space-y-3">
              ...
              <div>
                <button
                  type="button"
                  class="w-full flex items-center justify-between text-sm text-white/80 font-semibold py-2"
                ...
                <div v-if="inviteOpen" class="mt-2">
                  <input
            ...
            <div v-else class="space-y-3">
              <div class="flex items-center gap-2 mb-2">
                ...
                <div class="flex-1 text-center text-sm font-semibold text-white truncate px-2">Create Account</div>
                <div class="w-8"></div>
              </div>
          ...
          <form v-else @submit.prevent="handlePhoneRegister" class="space-y-3">
